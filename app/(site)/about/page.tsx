    ...
    <div className="mx-auto max-w-3xl px-5 py-14">
      <header>
        ...
        <p className="mt-5 text-pretty text-xl leading-relaxed text-muted-foreground">
          Take a Seat is a small project run by two Merseyside companies who kept meeting the same
          skip from opposite ends - which neither wanted to see filled.
        </p>
      </header>
      ...
      <section className="mt-12 rounded-2xl border border-border bg-secondary/40 p-8">
        <p className="text-lg leading-relaxed text-foreground/90">
          Between them: one company that can save the timber, and one that can find it a home. That
          really is the whole operation. If you&apos;d like to talk to a person, we&apos;re at{' '}
          <a

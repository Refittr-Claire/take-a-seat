...
const faqs = [
  {
    q: 'Is it really free?',
    a: "Yes, properly free. There's no cost to you and no invoice later. We save the pews, and we give them away.",
  },
  {
    ...
    <div className="mx-auto max-w-3xl px-5 py-14">
      <header>
        ...
        <p className="mt-5 text-pretty text-xl leading-relaxed text-muted-foreground">
          If you run somewhere people gather, whether that&apos;s a park, a hospice, a care home, a
          school, a library or a community centre, we&apos;d like to give you somewhere to sit.
        </p>
      </header>

      <section className="mt-10 space-y-6 text-lg leading-relaxed text-foreground/90">
        <p>
          It&apos;s simple enough. We have salvaged church pews, made into benches, free to good
          homes across Merseyside. Indoor or outdoor, one or many. You tell us where, and we&apos;ll
          find the right one and bring it over.
        </p>
      </section>
      ...
      <section className="mt-10 rounded-2xl border border-border bg-card p-8">
        ...
        <p className="mt-4 text-lg leading-relaxed text-foreground/90">
          ...
          It&apos;s a prompt to sit down together and talk, nothing more, and we&apos;d welcome a
          look over the questions by someone with dementia-care experience before they go out.
        </p>
      </section>
